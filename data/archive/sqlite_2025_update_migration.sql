...
-- Format: SQLite (uses datetime("now") for timestamps)
-- SQLite version: replace datetime('now') with datetime('now')
-- ============================================================
...
INSERT OR IGNORE INTO policy_ideas (
...
UPDATE policy_ideas SET
  feasibility_note = 'Implemented: announced at MTBPS November 2025, effective immediately. SARB MPC now formally targets 3% CPI (±1pp). First test is the 2026 interest rate cycle. Market reaction post-announcement: long bond yields compressed modestly, consistent with improved credibility. Political risk: low — SARB constitutional independence insulates the target from political interference. Directly linked to S&P sovereign outlook upgrade and fiscal consolidation narrative.',
  updated_at     = datetime('now')
WHERE id = 124;
