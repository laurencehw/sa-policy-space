...
const DependencyGraph = dynamic(() => import('@/components/DependencyGraph'), {
  ...
  loading: () => (
    <div className="h-[600px] rounded-xl border border-gray-200 bg-gray-50 flex flex-col items-center justify-center gap-3">
      ...
      />
      <p className="text-gray-400 text-sm">Rendering 123-node dependency graph...</p>
      <p className="text-gray-300 text-xs">Hover nodes to see connections, click for details, drag to rearrange</p>
    </div>
  ),
})
