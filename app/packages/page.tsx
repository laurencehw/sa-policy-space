    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between">
        ...
        <a
          ...
          target="_blank"
          className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 transition-colors font-medium flex-shrink-0"
        >
